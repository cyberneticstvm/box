                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a class="icon-masking" href="{{ route('landing') }}"><span data-mask-src="{{ asset('/web/assets/img/logo-small.webp') }}" class="mask-icon"></span><img src="{{ asset('/web/assets/img/logo-small.webp') }}" alt="Move N Store"></a>
                            </div>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('contact') }}" class="th-btn shadow-none d-inline-block">Get A Quote<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
==============================-->
    <div class="th-hero-wrapper hero-8" id="hero">
        <div class="hero-inner">
            <div class="th-hero-bg" data-bg-src="{{ asset('/web/assets/img/hero/bg-img.webp') }}">
            </div>
            <div class="container th-container4">
                <div class="row justify-content-center align-items-center">
                    <div class="col-xxl-5 col-xl-6">
                        <div class="hero-style8">
                            <span class="sub-title">Welcome to the Ultimate Smart Storage Solution</span>
                            <h1 class="hero-title"> <span class="text-theme">Your <span class="fw-normal">one stop </span></span> storage and moving partner</h1>
                            <p class="hero-text">From a small box to whole house or office items at movenstore we pack, pick, store and deliver.</p>
                            <div class="btn-group mt-30">
                                <a href="{{ route('pandm') }}" class="th-btn style7 style-radius">Know More</a>
                                <a href="{{ route('about') }}" class="th-btn style7 style-radius">About Us</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7 col-xl-6">
                        <div class="th-hero-thumb">
                            <img src="{{ asset('/web/assets/img/hero/bg2-img.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
...
==============================-->
	...
	******************************** -->
    ...
    <div class="modal fade" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" id="onload">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('contact.submit') }}" method="POST" class="contact-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control border" name="name" id="name" value="{{ old('name') }}" placeholder="Your Name" required>
                                <i class="fal fa-user"></i>
                                @error('name')
                                <small class="text-danger">{{ $errors->first('name') }}</small>
                                @enderror
                            ...
                            <div class="form-group col-md-12">
                                <input type="tel" class="form-control border" name="number" id="number" value="{{ old('number') }}" placeholder="Phone Number" required>
                                <i class="fal fa-phone"></i>
                                @error('number')
                                <small class="text-danger">{{ $errors->first('number') }}</small>
                                @enderror
                            ...
                            <div class="form-group col-md-12">
                                <select class="form-control border" name="service" id="service" required>
                                    <option value="">Select Service</option>
                                    <option value="pack-and-move">Packers & Movers</option>
                                    <option value="household-storage">Household Storage</option>
                                    <option value="box-storage">Box Storage</option>
                            ...
                            <div class="form-group col-12">
                                <textarea name="message" id="message" cols="30" rows="3" class="form-control border" placeholder="Your Message" required>{{ old('message') }}</textarea>
                                <i class="fal fa-comment"></i>
                                @error('message')
                                <small class="text-danger">{{ $errors->first('message') }}</small>
                                @enderror
                            </div>
                            <div class="form-btn text-xl-start col-12">
                                <button type="submit" class="th-btn btn-submit">Submit<i class="fa-regular fa-arrow-right ms-2"></i></button>
                            </div>
                        </div>
                        <p class="form-messages mb-0 mt-3"></p>
